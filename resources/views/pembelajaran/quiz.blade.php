        ...
        <div id="pengantar" class="col-12 col-xl-7 text-pembelajaran">
            ...
            <div class="quiz mt-4">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="{{$prt->id}}" value="{{$prt->pilihan_a}}"
                        id="flexRadioDefault1">
                    <label class="form-check-label" for="flexRadioDefault">{{$prt->pilihan_a}}</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="{{$prt->id}}" value="{{$prt->pilihan_b}}"
                        id="flexRadioDefault1">
                    <label class="form-check-label" for="flexRadioDefault">{{$prt->pilihan_b}}</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="{{$prt->id}}" value="{{$prt->pilihan_c}}"
                        id="flexRadioDefault1">
                    <label class="form-check-label" for="flexRadioDefault">{{$prt->pilihan_c}}</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="{{$prt->id}}" value="{{$prt->pilihan_d}}"
                        id="flexRadioDefault1">
