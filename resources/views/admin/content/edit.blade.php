        ...
        <div class="col-lg-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('content.update', ['id'=>$data->id])}}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="course_content" class="form-control" id="inputcourse_content"
                                aria-describedby="emailHelp" value="{{$data->course_content}}">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="lesson_content" class="form-control" id="inputlesson_content"
                                aria-describedby="emailHelp" value="{{$data->lesson_content}}">
                        </div>
