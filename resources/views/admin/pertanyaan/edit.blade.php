                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pertanyaan" class="form-control" id="inputpertanyaan"
                                    aria-describedby="emailHelp" value="{{$data->pertanyaan}}">
                            </div>
                            <div class="mb-3">
                                <label for="inputgambar" class="form-label">Gambar</label>
                                <input type="file" name="gambar" class="form-control" id="inputgambar"
                                    aria-describedby="emailHelp" value="{{$data->gambar}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="pilihan_a" class="form-control" id="inputpilihan_a"
                                    aria-describedby="emailHelp" value="{{$data->pilihan_a}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="pilihan_b" class="form-control" id="inputpilihan_b"
                                    aria-describedby="emailHelp" value="{{$data->pilihan_b}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="pilihan_c" class="form-control" id="inputpilihan_c"
                                    aria-describedby="emailHelp" value="{{$data->pilihan_c}}">
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="pilihan_d" class="form-control" id="inputpilihan_d"
                                    aria-describedby="emailHelp" value="{{$data->pilihan_d}}">
                            </div>
                            <div class="mb-3">
                                <label for="jawaban" class="form-label">Jawaban</label>
                                <input type="text" name="jawaban" class="form-control" id="jawaban"
                                    aria-describedby="emailHelp" value="{{$data->jawaban}}">
                            </div>
