                        ...
                        <div class="col-md-12 d-flex">
                            ...
                            <div class="ms-auto p-2 bd-highlight">
                                ...
                                <a class="btn btn-lg btn-primary"
                                    href="{{route('peserta.pelatihan.enroll', [$pelatihan->id])}}">Enroll</a>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-start">
                                    <label class="form-check-label">
                                        <input type="checkbox" name="dapatDiUlang" value="1" class="form-check-input" style="margin-top:6px;">
        ...
        <div class="col-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="card-title" style="font-family:glory; font-size:20px;">Detail Konten Pelatihan</h5>
                        </div>
                    </div>
                    <div class="row">
                        @foreach($topiks as $tp)
