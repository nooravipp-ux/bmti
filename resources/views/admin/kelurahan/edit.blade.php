...
@section('title', 'BMTI - Edit Data Kelurahan')
@section('content')
        ...
        <div class="col-lg-12 grid-margin marginResponsive">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('kelurahan.update', ['id'=>$data->id])}}" method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_desa_kelurahan" class="form-control" id="nama_desa_kelurahan"
                                aria-describedby="emailHelp" required value="{{$data->nama_desa_kelurahan}}">
                        </div>
