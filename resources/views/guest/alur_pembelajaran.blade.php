        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 road-map text-center">
                ...
                <div id="step2" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3 mt-1">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/list-galeria.PNG')}}" alt="" width="550" height="330" />
                        </div>
                ...
                <div id="step3" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/kompetensi-kejuruan.PNG')}}" alt="" width="550" height="330" />
                        </div>

                        <div class="col-12 col-xl-6">
                            <h3 class="text-light"><b>STEP 2 - KOMPETENSI KEJURUAN</b></h3>
                            <h3 class="text-light">Menyajikan deskripsi materi pembelajaran dengan: H5P, video shooting merekam gambar bergerak, animasi seolah bergerak yang disajikan dengan citra/sudut pandang 2 dimensi maupun 3 dimensi serta dilengkapi materi pendukung berformat
                                pdf.
                            </h3>
                        </div>
                    </div>
                ...
                <div id="step4" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/kk-materi.PNG')}}" alt="" width="550" height="330" />
                        </div>
                ...
                <div id="step5" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/gambar-minat.PNG')}}" alt="" width="550" height="330" />
                        </div>
                ...
                <div id="step6" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/list-pelatihan-mandiri.PNG')}}" alt="" width="550" height="330" />
                        </div>
                ...
                <div id="step7" class="d-none">
                    <div class="row">
                        <div class="col-12 col-xl-6 mb-3">
                            <img class="alur-img center rounded" src="{{asset('guest/assets/images/gambar-terbimbing.PNG')}}" alt="" width="550" height="330" />
                        </div>
                ...
                <div id="step8" class="d-none">
                    <div class="row justify-items-center">
                        <div class="col-12">
                            ...
                            <div class="mb-3">
                                <img class="sertifikat-img center rounded" src="{{asset('guest/assets/images/sertifikat2.PNG')}}" alt="" width="500" height="550" />
                            </div>
                            <h3 class="text-light">
                                Setelah peserta menyelesaikan pelatihan terbimbing, maka peserta akan mendapatkan sertifikat sesuai dengan pelatihan yang sudah diambil.
                            </h3>
                        </div>
                    </div>
                    <div class="text-center">
